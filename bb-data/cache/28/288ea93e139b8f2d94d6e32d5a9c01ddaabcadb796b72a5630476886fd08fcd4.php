...
/* partial_menu.phtml */
class __TwigTemplate_d02da708f8e330378773194079809ef6b5b832eb62a40c0c908d329061a5716d extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% for location,group in navigation %}
    ...
    {% endif %}
{% endfor %}
</ul>", "partial_menu.phtml", "/var/www/bb-themes/admin_default/html/partial_menu.phtml");
    }
}
